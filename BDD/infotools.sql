...
--
-- Client :  localhost
-- Généré le :  Mar 28 Avril 2026 à 09:36
...
(39, '2026-03-18 16:25:02', 'mpereira', 'UPDATE', 'Client', '24', '{"IdClient":24,"Nom":"Lambert","Prenom":"Rose","Entreprise":"SoftDev","Email":"r.lambert@soft.net","Telephone":"0610000024","Adresse":"Perpignan","Statut":"Client","NomComplet":"\\uD83D\\uDC64 [CLIENT] LAMBERT Rose (SoftDev)"}', '{"IdClient":24,"Nom":"Lambert","Prenom":"Rose","Entreprise":"SoftDev","Email":"r.lambert@soft.net","Telephone":"0610000024","Adresse":"Perpignan","Statut":"Prospect","NomComplet":"\\uD83C\\uDFAF [PROSPECT] LAMBERT Rose (SoftDev)"}'),
(40, '2026-03-26 14:52:17', 'mpereira', 'DELETE', 'RendezVous', '45', '{"Id":45,"Titre":"RDV Client: Blanchard","NomClient":"","DateHeure":"2025-01-06T11:00:00","Lieu":"","NomUtilisateur":null,"IdClient":26,"IdUtilisateur":2}', 'null'),
(41, '2026-04-01 14:08:28', 'mpereira', 'UPDATE', 'Client', '30', '{"IdClient":30,"Nom":"Brunet","Prenom":"Margaux","Entreprise":"ComNet","Email":"m.brunet@com.fr","Telephone":"0610000030","Adresse":"La Rochelle","Statut":"Client","NomComplet":"\\uD83D\\uDC64 [CLIENT] BRUNET Margaux (ComNet)"}', '{"IdClient":30,"Nom":"Brunet","Prenom":"Margaux","Entreprise":"ComNet","Email":"m.brunet@com.fr","Telephone":"0610000030","Adresse":"La Rochelle","Statut":"Client","NomComplet":"\\uD83D\\uDC64 [CLIENT] BRUNET Margaux (ComNet)"}'),
(42, '2026-04-01 14:09:08', 'mpereira', 'INSERT', 'RendezVous', 'N/A', 'null', '{"IdClient":30,"Date":"2025-01-08T09:00:00","Titre":"RDV CLIENT : Brunet","IdUtilisateur":3}'),
(43, '2026-04-01 14:09:32', 'mpereira', 'INSERT', 'Facture', '2', 'null', '{"IdFacture":2,"IdClient":30,"NomClient":"","DateFacture":"2026-04-01T14:09:32.740769+02:00","TotalTTC":575.00,"Lignes":[{"IdLigne":0,"IdFacture":0,"IdProduit":3,"NomProduit":"Onduleur APC Smart-UPS 1500VA","Quantite":1,"PrixUnitaire":480.00,"SousTotal":480.00},{"IdLigne":0,"IdFacture":0,"IdProduit":12,"NomProduit":"Windows Server 2022 Standard","Quantite":1,"PrixUnitaire":95.00,"SousTotal":95.00}]}');
...
(24, 'Lambert', 'Rose', 'SoftDev', 'r.lambert@soft.net', '0610000024', 'Perpignan', '2025-03-04 00:00:00', 'Prospect'),
...
INSERT INTO `facture` (`IdFacture`, `IdClient`, `DateFacture`, `TotalTTC`) VALUES
(1, 18, '2026-03-11 16:13:17', '180.00'),
(2, 30, '2026-04-01 14:09:33', '575.00');
...
INSERT INTO `lignefacture` (`IdLigne`, `IdFacture`, `IdProduit`, `Quantite`, `PrixUnitaire`) VALUES
(1, 1, 10, 1, '85.00'),
(2, 1, 6, 1, '95.00'),
(3, 2, 3, 1, '480.00'),
(4, 2, 12, 1, '95.00');
...
(3, 'Onduleur APC Smart-UPS 1500VA', 'Infrastructure', '480.00', 24),
...
(12, 'Windows Server 2022 Standard', 'Logiciel', '95.00', 49),
...
(47, 'RDV CLIENT : Brunet', '', '2025-01-08 09:00:00', 'Bureau', NULL, 30, 3);
...
--
ALTER TABLE `rendezvous`
  MODIFY `IdRdv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `lignefacture`
  ADD CONSTRAINT `lignefacture_ibfk_1` FOREIGN KEY (`IdFacture`) REFERENCES `facture` (`IdFacture`) ON DELETE CASCADE,
  ADD CONSTRAINT `lignefacture_ibfk_2` FOREIGN KEY (`IdProduit`) REFERENCES `produit` (`Id`);
